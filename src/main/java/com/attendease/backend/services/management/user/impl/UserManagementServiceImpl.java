...
package com.attendease.backend.services.management.user.impl;
...
import com.attendease.backend.repository.user.UserRepository;
...
public class UserManagementServiceImpl {
     ...
     */
    public UserManagementServiceImpl(Firestore firestore,StudentRepository studentRepository,UserRepository userRepository, PasswordEncoder passwordEncoder ) {
