...
import com.attendease.backend.authentication.student.dto.LoginRequest;
...
public class StudentAuthenticationController {
    ...
    @PostMapping("/login")
    public ResponseEntity<String> loginStudent(@Valid @RequestBody LoginRequest loginRequest) {
        try {
